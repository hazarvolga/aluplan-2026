...
export default function Page() {
  ...
  return (
    <div className="dark min-h-screen bg-graphite-950">
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <Badge className="mb-6 bg-accent/20 text-accent border-accent/30">allplan precast</Badge>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button size="lg" variant="outline" asChild><Link href="/contact">Teklif Alın</Link></Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-accent/10"><div className="container mx-auto px-4 text-center"><h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">ALLPLAN Precast&apos;i Keşfedin</h2><p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Prefabrik beton projeleriniz için kapsamlı BIM çözümü.</p><div className="flex flex-wrap gap-4 justify-center"><Button size="lg" className="bg-accent hover:bg-accent/90" asChild><a href="https://www.allplan.com/trial-or-subscription/" target="_blank" rel="noopener noreferrer">Ücretsiz Dene<ArrowRight className="ml-2 h-5 w-5" /></a></Button><Button size="lg" variant="outline" asChild><Link href="/contact">Teklif Alın</Link></Button></div></div></section>
    </div>
  );
}
