  ...
  return (
    <div className="dark min-h-screen bg-graphite-950">
      <SolutionHero
        ...
        title="PythonParts"
        description="Allplan için parametrik, akıllı obje şablonları: hızlı modelleme ve tekrar kullanılabilirlik"
      ...
      <div className="bg-background">
        <InfoMediaTwoColumn
          ...
          description="PythonParts ile parametrik geometriler tasarlayın ve projelerinizde tekrar kullanın"
