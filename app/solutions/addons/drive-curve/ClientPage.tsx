...
export default function ClientPage() {
  ...
  const sections = [
    ...
    <ApplicationAreas key="areas-functional" title="İşlevsel genel bakış" items={[{ icon: iconFahrspur, title: "Sürüş İzi", titleDE: "Fahrspur", description: "Araç hareket yolu" }, { icon: iconFahrspurErzeugen, title: "Sürüş İzi Oluştur", titleDE: "Fahrspur erzeugen", description: "Yeni rota oluşturma" }, { icon: iconFahrzeugEditor, title: "Araç Editörü", titleDE: "Fahrzeug-Editor", description: "Araç özelleştirme" }, { icon: iconFahrspurAndern, title: "Sürüş İzini Değiştir", titleDE: "Fahrspur ändern", description: "Rota düzenleme" }, { icon: iconLizenzAnzeigen, title: "Lisans Göster", titleDE: "Lizenz anzeigen", description: "Lisans bilgisi" }]} />,
    ...
    <section key="gallery" className="py-16 bg-background"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><ImageGallery images={galleryImages} sectionTitle="Galeri" sectionDescription="" hideCategoryFilter /></div></section>
  ];
