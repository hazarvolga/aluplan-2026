...
export default function BuildingDesignPage() {
    // "BİNA TASARIMI" items from menu
    const category = solutionsMenu.find(s => s.title === "BİNA TASARIMI");
    ...
    return (
        <PageWrapper>
            <HeroInternal
                category="ÇÖZÜMLER"
                title="BİNA TASARIMI"
                subtitle="Mimari, Strüktürel ve MEP disiplinleri için entegre tasarım araçları."
            />
