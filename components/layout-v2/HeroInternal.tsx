...
export const HeroInternal = ({ title, subtitle, category }: HeroInternalProps) => {
    return (
        <section className="relative pt-32 pb-16 px-6 md:px-12 lg:px-24 border-b border-border/10 overflow-hidden">
            {/* Background Glow */}
            <div className="absolute top-0 right-0 w-[800px] h-[600px] bg-accent rounded-full blur-[200px] opacity-[0.05] pointer-events-none" />
