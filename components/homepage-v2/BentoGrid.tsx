...
const BentoGrid = () => {
    return (
        <section className="bg-[#050505] py-24 px-6 md:px-12 lg:px-24 text-white">
            <div className="max-w-[1400px] mx-auto">
                <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
                    ...
                    <button className="text-sm border-b border-gray-700 pb-1 hover:border-white transition-colors uppercase tracking-widest">
                        Tüm Çözümleri Gör
                    </button>
                </div>
